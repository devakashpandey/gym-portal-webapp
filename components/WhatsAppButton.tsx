...
export default function WhatsAppButton() {
    ...
    // Auto-show tooltip after 5 seconds (desktop only)
    useEffect(() => {
        const timer = setTimeout(() => {
            if (isVisible && window.innerWidth > 768) setShowTooltip(true);
        }, 5000);
    ...
    const message = encodeURIComponent(
        "Hi! I'm interested in joining SUSPENDED Fitness Club. Can you share more details?"
    );
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        👋 Need help choosing a plan? Chat with us on WhatsApp!
                    </p>
                    {/* Arrow */}
                    <div
                        style={{
